---
title: "Doctoral Researcher in Trustworthy World Models for Critical Systems — Power Grids"
collection: positions
permalink: /position/phd-power-grids
category: phd
status: open
...
Both PhD positions are part of the same research effort on **Trustworthy World Models for multimodal vision-graph-tabular settings**, and the two candidates will work closely together on shared neuro-symbolic encoder architectures and certification methods, while each specializing in the mathematical/physical structure and stakeholder priorities of their own application domain.
