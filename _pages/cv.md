...
* *Research Scientist*
 @ SnT - University of Luxembourg, 2026-...

I am a Research Scientist at SnT - University of Luxembourg. I a working among others, on designing robust foundation Graph foundation models for Geometric Critical Systems. My focus is the understanding, the analysis, and mitigation of current and prospective reliability threats for Machine Learning-based systems. Mainly in the fields of Financial Machine Learning, Smart Grids, and Medical Diagnosis. 
...
Technical lead on 2 FNR CORE Projects:

FM2MRI (2025-2028; FNR): Building on existing technology called the Mixture of Experts architecture where we combine multiple machine learning models that are trained to specialize in different part of the brain images. We're training our system using a method called Multimodal self-supervised learning, which is a way of teaching it to recognize patterns in the images without needing lots of labeled examples. Instead, it learns by comparing similar and different images to understand what's important. Overall, our goal is to make MRI analysis and synthesis more accurate and efficient, which will ultimately help doctors make better diagnoses and treatment plans for patients.
